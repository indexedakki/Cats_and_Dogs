...
# https://learn.microsoft.com/en-us/visualstudio/bridge/kubernetes-environment-variables
# https://learn.microsoft.com/en-us/visualstudio/bridge/bridge-to-kubernetes-vs-code
# The servicename is the name of the service, converted to uppercase, 
# and with hyphens converted to underscores
# below HOST_NAME, PORTA, PORTB is defined to use Kubernetes environment variables during debugging
# using Bridge to Kubernetes VS Code extension
# in the tasks.json file set "useKubernetesServiceEnvironmentVariables": true
import os
HOST_NAME = os.environ.get("TENSORFLOW_SERVING_SERVICE_HOST")
PORTA = os.environ.get("TENSORFLOW_SERVING_SERVICE_PORT_PORTA")
PORTB = os.environ.get("TENSORFLOW_SERVING_SERVICE_PORT_PORTB")
MODEL_URI='http://{}:{}/v1/models/my_model:predict'.format(HOST_NAME, PORTB)
